class FourecastResponseModel {
  FourecastResponseModel({
      this.cod, 
      this.message, 
      this.cnt, 
      this.list, 
  ...
  FourecastResponseModel.fromJson(dynamic json) {
    cod = json['cod'];
  ...
  City? city;
FourecastResponseModel copyWith({  String? cod,
  num? message,
  num? cnt,
  List<ForeCastItem>? list,
  City? city,
}) => FourecastResponseModel(  cod: cod ?? this.cod,
